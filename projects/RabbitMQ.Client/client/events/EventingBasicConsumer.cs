...
namespace RabbitMQ.Client.Events
{
    ...
    public class EventingBasicConsumer : DefaultBasicConsumer
    {
        ...
        /// be already released.
        /// </remarks>
        public override bool HandleBasicDeliver(string consumerTag, ulong deliveryTag, bool redelivered, string exchange, string routingKey, IBasicProperties properties, ReadOnlyMemory<byte> body)
        {
