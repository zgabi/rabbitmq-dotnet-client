...
namespace RabbitMQ.Client.Framing.Impl
{
    internal readonly struct ExchangeDeclare : IOutgoingAmqpMethod
    {
        ...
        public ExchangeDeclare(in CachedString Exchange, string Type, bool Passive, bool Durable, bool AutoDelete, bool Internal, bool Nowait, IDictionary<string, object> Arguments)
        {
            _exchange = Exchange;
            _type = Type;
            _passive = Passive;
