...
{
    internal readonly struct QueueBind : IOutgoingAmqpMethod
    {
        // deprecated
        // ushort _reserved1
        ...
        public QueueBind(string Queue, in CachedString Exchange, in CachedString RoutingKey, bool Nowait, IDictionary<string, object> Arguments)
        {
            _queue = Queue;
            _exchange = Exchange;
        ...
        public ProtocolCommandId ProtocolCommandId => ProtocolCommandId.QueueBind;
